...
As described in http://arxiv.org/abs/1602.07261.
  ...
  Taken from https://raw.githubusercontent.com/davidsandberg/facenet/master/src/models/inception_resnet_v1.py
"""
...
# Following functions are for stylize.py.
def get_net_all_variables():
    t_vars = tf.trainable_variables()
    return [var for var in t_vars if 'InceptionResnetV1' in var.name]
