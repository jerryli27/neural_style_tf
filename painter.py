...
class Painter(object):
    def __init__(self, save_dir,num_styles, gpu=0, gpu_fraction = 0.5, mat_dir = 'imagenet-vgg-verydeep-19.mat', do_save_npy = False, npy_path = None,):
        ...
        self.painter = n_style_out_net.Stylizer(mat_dir,128,128,num_styles, use_johnson=True, save_dir=save_dir,
                                                do_save_npy=do_save_npy,npy_path=npy_path,
